...
public class Lec03DoCallbacks {
    ...
    public static void main(String[] args) {
        ...
        Flux.<Integer>create(fluxSink -> {
                ...
                .doOnComplete(() -> log.info("doOnComplete-1"))  //registra una acción justo antes de emitir onComplete, pero solo en caso de finalización exitosa
                .doFirst(() -> log.info("doFirst-1")) // ejecuta el side-effect antes de cualquier suscripción, justo en el ensamblado. Si encadenas varios doFirst, se invocan en orden inverso al declarado
